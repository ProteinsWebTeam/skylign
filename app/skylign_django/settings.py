"""
Django settings for skylign_django project.
...
configs = yaml.safe_load(open(f"{BASE_DIR}/config/{config_file}"))

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = configs['django']['secret_key']
...
ROOT_URLCONF = "skylign_django.urls"
...
WSGI_APPLICATION = "skylign_django.wsgi.application"
...
DATABASES = {
    'default': {
        ...
        # 'SQL_DATABASE': configs['database']['database'],
        'NAME': configs['database']['database'],
